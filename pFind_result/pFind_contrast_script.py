...
wd_path = r"/Users/yong/Documents/OneDrive/temp/LuShan_pFind_merge_problem" # important the pFind.protein path
...
def write_dic2_file(final_dic, sp_list, w_name):
    ...
    line2_list = ["Protein", "", ""]
    line2_list.extend(["Total_pep_num@pro(Total_unique_pep_num@pro)","Total_pep_num@pro(Total_unique_spec_num@pro)", "have unique peptide?", ""]* len(sp_list))
