                            ...
                            for h in range(g + 1, len(all_AA)):
                                ...
                                for x in range(len(mass_list) - 1):
                                    delta_list.append(mass_list[x + 1] -
                                                      mass_list[x])
                                pair = all_AA[m] + "/" +all_AA[n] +", " + all_AA[i] + "/" +all_AA[j] +", "\
                                    + all_AA[a] + "/" + all_AA[b] + ", "+ all_AA[g] + "/" + all_AA[h]
